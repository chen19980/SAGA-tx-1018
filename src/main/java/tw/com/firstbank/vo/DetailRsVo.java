...
@ApiModel(description = "Detail 結果")
@Data
@NoArgsConstructor
public class DetailRsVo implements Serializable {
    ...
    @ApiModelProperty(notes = "ts", required = true, example="\"2022-09-18T07:30:31.275161800Z\"")
    @JsonProperty("ts")
    private Instant ts;
}
