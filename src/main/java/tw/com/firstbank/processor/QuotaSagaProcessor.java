...
@Slf4j
@Component
@SagaInfo(name = "quota_saga")
public class QuotaSagaProcessor extends BaseSagaProcessor<QuotaRqVo, QuotaRsVo> {
...
//                .option(SAGA_SEQ_NAME, setSeq("03"))
...
//                .setProperty(SAGA_SEQ_NAME, getSeq())
                ...
                .choice()
                .when(canExecuteSaga())
                .to("bean:quotaProcessor?method=doTransaction")
                .bean(this, "toRs")
                .bean(this, "sagaDone")
                .otherwise()
        ...
        from(SAGA_COMPENSATE_NAME)
                ...
                .to("bean:quotaProcessor?method=compensateTransaction")
    ...
    public Object toRs(Exchange exchange) {
        QuotaRsVo rs = (QuotaRsVo) exchange.getIn().getBody();
